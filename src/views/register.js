    ...
    <div className="register-container" style={{height: "100vh"}}>
      ...
      <footer className="register-footer">
        <div className="register-container2">
          ...
          />
          <nav className="register-nav2">
            <span className="register-text3">Design</span>
            <span className="register-text4">Create</span>
            <span className="register-text5">Refine</span>
            <span className="register-text6">Deploy</span>
          </nav>
        </div>
